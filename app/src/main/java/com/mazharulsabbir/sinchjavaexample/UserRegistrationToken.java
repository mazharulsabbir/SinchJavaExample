...
public class UserRegistrationToken {
    private static final String TAG = "UserRegistrationToken";
    ...
    private final OffsetDateTime instanceExpiresAt;
    ...
    public String toJwt() {
        ...
        // order (for the same reason of comparison)
    ...
    public String toString() {
        return "UserRegistrationToken{" +
                ...
                ", applicationSecret=" + Arrays.toString(applicationSecret) +
                ", userId='" + userId + '\'' +
                ", nonce='" + nonce + '\'' +
                ", issuedAt=" + issuedAt +
                ", expiresAt=" + expiresAt +
